...
static apg_uint examples(APG_CBDATA* spData){
	  ...
	  if(spData->uiState == PRE_AST){
		  ...
		  fprintf(spCallbackCtx->spFile, "Copyright &copy; 2012 Coast to Coast Research, Inc.<br\\>");
		  fprintf(spCallbackCtx->spFile, "<a href=\"http://www.coasttocoastresearch.com/\">http://www.coasttocoastresearch.com/</a>");
