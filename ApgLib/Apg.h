...
*******************************************************************************/
/** \mainpage APG - an <i>A</i>BNF <i>P</i>arser <i>G</i>enerator
...
<b>ApgLib</b> is the basic library. It has the API for the parser itself. It is designed
...
<b>ApgUtilities</b>, as the name implies, is a library of utility functions.
...
<b>Generator</b> is the parser generator. It reads an SABNF grammar and generates a parser in the
...
<li>MEGACO</li>
<li>SIP</li>
<li>WideCharacters</li>
</ul>

<b>Demo</b> is a simple "Hello World" example of a parser. It demonstrates most of the basic
APG operations and gives examples of how to write and set up rule and UDT callback functions.

<b>CppDemo </b> gives a simple example of setting up a C++ parser.

<b>MEGACO</b>. Since many APG users use it in their applications to parse MEGACO messages
(<a href="http://www.ietf.org/rfc/rfc3525.txt?number=3525">RFC 3525</a>) an example is given
on how to set up a C++ parser for this grammar.

<b>SIP</b> is an in-depth study of using UDTs to significantly speed up the parsing process
without altering the language of interest.
The SIP (<a href="http://www.ietf.org/rfc/rfc3261.txt?number=3261">RFC 3261</a>) grammar has been selected for this study because it is a
substantial (300+ rule names) and <a href="http://en.wikipedia.org/wiki/List_of_SIP_software">commercially significant</a> grammar.

<b>WideCharacters</b> is an example of using an alphabet character width greater than 8 bits.
